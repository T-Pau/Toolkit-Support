...
## [AssemblerOutput](AssemblerOutput.md)

Create assembler source files in [Accelerate](https://accelerate.tpau.group/) format.


## [AtomicOutput](AtomicOutput.md)
...
## [CharacterImage](CharacterImage.md)

Convert image to characters.


## [CharacterMapping](CharacterMapping.md)
...
## [FilePositionException](FilePositionException.md)
...
## [MessageHandlerCollect](MessageHandlerCollect.md)

Collect messages in list.


## [MessageHandlerFile](MessageHandlerFile.md)
...
## [PaletteImage](PaletteImage.md)

Image converted to color indices.


## [RunlengthEncoder](RunlengthEncoder.md)
